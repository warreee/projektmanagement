...
\textsc{\Large Projektmanagement I}\\[0.5cm] % Major heading such as course name
\textsc{\large Zusammenfassung}\\[0.5cm] % Minor heading such as course title
...
\emph{Dozent:} \\
Dr.-Ing. Manfred Mach \\ % Supervisor's Name
